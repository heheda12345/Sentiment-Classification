...
class DeepCNN(nn.Module):
    def __init__(self, embedding, _, opt):
        ...
        self.dropout = nn.Dropout(self.args['dropoutRate'])
        self.fc = nn.Linear(self.args['co'] * 16, self.args['classNum'])
...
class RNN(nn.Module):
    def __init__(self, embedding, _, opt):
        ...
        self.fc = nn.Linear(self.args['hidden'] * 4, self.args['classNum'])
...
class MPMLP(nn.Module):
    def __init__(self, embedding, padding, opt):
        ...
        print(self.args)
        self.dropout = nn.Dropout(self.args['dropoutRate'])
        self.fc1 = nn.Linear(embedding, self.args['hidden'])
        self.sigmoid = nn.Sigmoid()
        self.fc2 = nn.Linear(self.args['hidden'], self.args['classNum'])
...
class MMPMLP(nn.Module):
    def __init__(self, embedding, padding, opt):
        ...
        print(self.args)
        self.dropout = nn.Dropout(self.args['dropoutRate'])
        self.fc1 = nn.Linear(embedding*2, self.args['hidden'])
        self.sigmoid = nn.Sigmoid()
        self.fc2 = nn.Linear(self.args['hidden'], self.args['classNum'])
...
class MLP(nn.Module):
    def __init__(self, embedding, padding, opt):
        ...
        print(self.args)
        self.dropout = nn.Dropout(self.args['dropoutRate'])
        self.fc1 = nn.Linear(embedding * padding, self.args['hidden'])
        self.sigmoid = nn.Sigmoid()
        self.fc2 = nn.Linear(self.args['hidden'], self.args['classNum'])
...
class FC(nn.Module):
    def __init__(self, embedding, padding, opt):
        ...
        print(self.args)
        self.dropout = nn.Dropout(self.args['dropoutRate'])
        self.fc = nn.Linear(embedding * padding, 8)
